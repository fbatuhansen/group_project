				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Bir Müşteri Seç <span>*</span></label>
							<div class="col-sm-4">
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Müşteri Mesajlarını Görüntüle</h1>
	</div>
</section>
					...
					<table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th width="200">Mesaj</th>
								<th width="200">Sipariş Detayları</th>
							</tr>
						</thead>
						<tbody>
							<?php
