...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="photo.php" class="btn btn-primary btn-sm">Hepsini Gör</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Resim Altyazı <span>*</span></label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="caption">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Resim Yükle<span>*</span></label>
