                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Ülke Seç <span>*</span></label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Miktar <span>*</span></label>
                            <div class="col-sm-4">
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Nakliye Maliyeti Görüntüle</h1>
	</div>
</section>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    ...
	                    <td>
	                        <a href="shipping-cost-edit.php?id=<?php echo $row['shipping_cost_id']; ?>" class="btn btn-primary btn-xs">Düzenle</a>
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">Not: Yukarıdaki listede bir ülke yoksa, aşağıdaki "Dünyanın Geri Kalanı" nakliye ücreti buna göre uygulanacaktır.</h4>
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Nakliye Maliyeti (Dünyanın geri kalanı)</h1>
    </div>
</section>
