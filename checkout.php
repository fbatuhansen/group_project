                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo $arr_cart_p_current_price[$i]; ?> TL</td>
                            ...
                            <td class="text-right">
                                ...
                                ?>
                                <?php echo $row_total_price; ?> TL
                            </td>
                        </tr>
                        <?php endfor; ?>           
                        <tr>
                            <th colspan="7" class="total-text"><?php echo LANG_VALUE_81; ?></th>
                            <th class="total-amount"><?php echo $table_total_price; ?> TL</th>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo $shipping_cost; ?> TL</td>
                        </tr>
                        <tr>
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
				                <div style="color:red;font-size:22px;margin-bottom:50px;">
			                        Siparişinizi kontrol etmek için fatura ve gönderim bilgilerini doldurmanız gerekir. Bilgilerinizi doldurmak için <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">TIKLAYIN</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
                                    ...
                                    <form class="paypal" action="<?php echo BASE_URL; ?>payment/paypal/payment_process.php" method="post" id="paypal_form" target="_blank">
                                        ...
                                        <input type="hidden" name="currency_code" value="TR" />
